...
import controle.DepositoController;
...
public class ControleDeposito extends javax.swing.JFrame implements Observer{
    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
               depositoController.criarDeposito(
	    		   Integer.parseInt(jtfQtdadeCritica.getText()), 
	    		   Integer.parseInt(jtfQtdadeMax.getText())
            	);
            }
        });
        ...
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                depositoController.addQuantidade(Integer.parseInt(jtfQtdade.getText()));
            }
        });
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                depositoController.removeQuantidade(Integer.parseInt(jtfQtdade.getText()));
            }
        });
	...
	public void criouDeposito() {
		jtfQtdadeCritica.setText("");
		jtfQtdadeMax.setText("");
	...
	public void erro(String message) {
		jLabel5.setText(String.valueOf(depositoController.getQuantidadeAtual()));
		JOptionPane.showMessageDialog(jButton1, message);
	}
