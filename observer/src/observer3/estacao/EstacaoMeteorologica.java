...
import observer3.dispositivos.Observador;
...
public class EstacaoMeteorologica {
	...
	private List<Observador> dispositivos = new ArrayList<>();
	...
	public void anexarDispositivo(Observador obs) {
		this.dispositivos.add(obs);
	}
	
	public void notificar() {
		// notificamos cada dispositivo com a temperatura e a umidade dos sensores
		for (Observador obs: dispositivos) {
			obs.receberMensagem(this.getTemperatura(), this.getUmidade());
		}
	}
